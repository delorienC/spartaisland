...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.providers.admin_user.driver' => 'string',
            'auth.providers.admin_user.model' => 'string',
            ...
            'filesystems.links./workspace/backend/public/storage' => 'string',
...
'auth.guards.api.driver','auth.guards.api.provider','auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.sanctum.driver',
'auth.guards.sanctum.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.admin_user.driver','auth.providers.admin_user.model',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./workspace/backend/public/storage','logging.default','logging.deprecations.channel',
...
'ADMIN_EMAIL','ADMIN_PASSWORD','PHP_PEST_DISABLE_COVERAGE',);
